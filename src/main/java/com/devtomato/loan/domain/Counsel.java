...
public class Counsel extends BaseEntity{
    ...
    @Column(columnDefinition = "varchar(50) DEFAULT NULL COMMENT '상담 요청자 주소'")
    private String address;

    @Column(columnDefinition = "varchar(50) DEFAULT NULL COMMENT '상담 요청자 상세주소'")
    private String addressDetail;

    @Column(columnDefinition = "varchar(5) DEFAULT NULL COMMENT '상담 요청자 지번'")
